...
interface ImportTutorFormProps {
  onSuccess: () => void;
  onClose: () => void;
}

const ImportTutorForm: React.FC<ImportTutorFormProps> = ({ onSuccess, onClose }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetchWithAuth('/tutores/import', {
        method: 'POST',
        body: formData,
        ...
        <div className="modal-body">
          ...
          <div style={{ marginBottom: '24px', padding: '16px', backgroundColor: '#f0f9ff', borderRadius: '8px', border: '1px solid #bae6fd' }}>
            ...
            <div style={{ backgroundColor: 'white', padding: '12px', borderRadius: '4px', marginBottom: '16px', fontFamily: 'monospace', fontSize: '0.9rem', overflowX: 'auto' }}>
              <strong>Nombre | Apellido | Email | Equipo ID</strong>
            </div>
            <div style={{ marginBottom: '16px' }}>
              <strong>Campos requeridos:</strong>
              <ul style={{ marginTop: '8px', paddingLeft: '20px' }}>
                <li><strong>Nombre:</strong> Nombre del tutor</li>
                <li><strong>Apellido:</strong> Apellido del tutor</li>
                <li><strong>Email:</strong> Email válido del tutor (ejemplo: tutor@ejemplo.com)</li>
                <li><strong>Equipo ID:</strong> ID numérico del equipo (ver tabla abajo)</li>
              </ul>
            </div>
            <div style={{ padding: '12px', backgroundColor: '#fef3c7', borderRadius: '4px', marginTop: '16px' }}>
              <strong>⚠️ Importante:</strong> Solo los administradores pueden importar tutores. El email debe ser único y no puede estar duplicado en el sistema.
            </div>
          </div>
...
export default ImportTutorForm;
