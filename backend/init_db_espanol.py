"""
Script para inicializar la base de datos con datos de ejemplo en español
"""
...
def init_db():
    """Inicializa la base de datos con datos de ejemplo en español"""
    db = SessionLocal()
    ...
    try:
        ...
        print("Base de datos inicializada correctamente con datos de ejemplo en español:")
        print("   - 3 equipos (A, B, C)")
        print("   - 3 usuarios (1 admin, 2 tutores)")
        print("   - 6 tutores (2 por equipo)")
        print("   - 15 estudiantes (5 por equipo)")
