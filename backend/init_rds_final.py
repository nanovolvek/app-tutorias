...
def init_rds_final():
    ...
    try:
        ...
        try:
            ...
            # Crear equipos A, B, C
            equipos_data = [
                {"nombre": "A", "descripcion": "Equipo A - Tutores y estudiantes"},
                {"nombre": "B", "descripcion": "Equipo B - Tutores y estudiantes"},
                {"nombre": "C", "descripcion": "Equipo C - Tutores y estudiantes"}
            ]
