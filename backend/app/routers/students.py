...
from app.schemas.student import Student as StudentSchema, StudentCreate, StudentUpdate, StudentWithSchool
...
def get_students(
    ...
    """Obtener lista de estudiantes con información del colegio"""
    ...
    # Construir la respuesta con la información del colegio
